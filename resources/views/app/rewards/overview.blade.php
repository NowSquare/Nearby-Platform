...
foreach ($rewards as $reward) {
  ...
  $metrics = \DB::table('metrics')->select(['count as views', 'data->fired_at as dates'])->where('type', 'App\Metrics\RewardViewCountMetrics')->where('metricable_id', $reward->id)->first();
